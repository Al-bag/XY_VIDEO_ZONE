            ...
            async function s(e, t, r, s, f) {
                ...
                try {
                    ...
                    let r = await fetch(t, {
                        ...
                        h = f === n.RSC_CONTENT_TYPE_HEADER;
                    if (h || (h = f.startsWith("text/plain")), !h || !r.ok) return c(l.toString());
                    let [_, y] = await i(Promise.resolve(r), {
                    ...
                    return "string" == typeof t ? function(e, t, r, n) {
                        if ("$" === n[0]) {
                            ...
                            switch (n[1]) {
                                ...
                                case "L":
                                    return {
                                        $$typeof: f, _payload: e = M(e, t = parseInt(n.slice(2), 16)), _init: v
                                    };
                                case "@":
